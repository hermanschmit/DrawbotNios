...
# Memory: mem_if_lpddr2_emif
MEM_0 := mem_if_lpddr2_emif
$(MEM_0)_NAME := mem_if_lpddr2_emif
$(MEM_0)_MEM_INIT_FILE_PARAM_NAME := ABS_RAM_MEM_INIT_FILENAME
$(MEM_0)_START := 0x00000000
$(MEM_0)_END := 0x1fffffff
$(MEM_0)_SPAN := 0x20000000
$(MEM_0)_HIERARCHICAL_PATH := mem_if_lpddr2_emif
$(MEM_0)_WIDTH := 128
...
$(MEM_1)_START := 0x20020000
$(MEM_1)_END := 0x2003f3ff
...
# Memory: onchip_picture_mem1
MEM_2 := c5g_qsys_onchip_picture_mem1
$(MEM_2)_NAME := onchip_picture_mem1
...
$(MEM_2)_START := 0x30000000
$(MEM_2)_END := 0x3003ffff
$(MEM_2)_SPAN := 0x00040000
$(MEM_2)_HIERARCHICAL_PATH := onchip_picture_mem1
$(MEM_2)_WIDTH := 8
$(MEM_2)_HEX_DATA_WIDTH := 8
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: onchip_picture_mem1
onchip_picture_mem1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
